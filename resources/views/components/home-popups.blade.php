...
<div class="offcanvas offcanvas-start bg-warning" data-bs-scroll="true" tabindex="-1" id="wishlist" aria-labelledby="wishlistLabel">
    ...
    <div class="offcanvas-body d-flex justify-content-center align-items-center">
        <x-signupform FormInputidName="user-name" FormInputemailName="user-email" pincode="user-pincode" FormInputpasswordName="user-password" FormId="wishlist-form" action="" />
    </div>
</div>
{{--wishlist--}}
